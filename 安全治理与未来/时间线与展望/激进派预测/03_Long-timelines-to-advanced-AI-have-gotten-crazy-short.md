...
**来源**: [https://helentoner.substack.com/p/long-timelines-to-advanced-ai-have](https://helentoner.substack.com/p/long-timelines-to-advanced-ai-have)

---

# "Long" timelines to advanced AI have gotten crazy short

原文链接: https://helentoner.substack.com/p/long-timelines-to-advanced-ai-have

# "Long" timelines to advanced AI have gotten crazy short

### The prospect of reaching human-level AI in the 2030s should be jarring

[![Helen Toner's avatar](ai-leaders-insights/安全治理与未来/时间线与展望/激进派预测/images/197079f4bc55edeae20e6c119bc48da4.jpeg)](ai-leaders-insights/安全治理与未来/时间线与展望/激进派预测/images/52151f8048fc052922ccbd3e595a0308.jpg)
...
[![](ai-leaders-insights/安全治理与未来/时间线与展望/激进派预测/images/50d3847a9d15789edd7eedcf98c2c569.png)](ai-leaders-insights/安全治理与未来/时间线与展望/激进派预测/images/69295ae41ef69779ae308b01297ba5fc.png)

[Source](https://x.com/HumanHarlan/status/1866216644089205039)
...
What counts as “short” timelines are now blazingly fast—somewhere between one and five years until human-level systems. For those in the “short timelines” camp, “AGI by 2027” had already become a popular talking point before one particular [online manifesto](https://situational-awareness.ai/) made a splash with that forecast last year. Now, the heads of the three leading AI companies are on the record with similar views: that 2026-2027 is when we’re “most likely” to build “AI that is smarter than almost all humans at almost all things” ([Anthropic’s CEO](https://darioamodei.com/on-deepseek-and-export-controls)); that AGI will probably be built by January 2029 ([OpenAI’s CEO](https://www.bloomberg.com/features/2025-sam-altman-interview)), and that we’re “probably three to five years away” from AGI ([Google DeepMind’s CEO](https://www.bigtechnology.com/p/google-deepmind-ceo-demis-hassabis)). The vibes in much of the AI safety community are correspondingly hectic, with people frantically trying to figure out what kinds of technical or policy mitigations could possibly help on that timescale.
...
> “AI systems will match and surpass human intellectual capabilities… probably over the next decade or two” ([video](https://x.com/slow_developer/status/1871027957411782827), [transcript](https://dig.watch/event/artificial-intelligence-ai-security-council/9821st-meeting))

**Gary Marcus:**

> [AGI will come] “perhaps 10 or 20 years from now” ([source](https://x.com/GaryMarcus/status/1871605871282999760))

**Arvind Narayanan:**

I initially had this quote from Arvind:

> “I think AGI is many many years away, possibly decades away” ([source](https://www.youtube.com/watch?v=VrRMOmxOb9A))
...
* We need to leap into action on many of the [same things](https://www.lawfaremedia.org/article/ai-regulation-s-champions-can-seize-common-ground-or-be-swept-aside) that could help if it does turn out that we only have a few years. These will likely take years and years to bear fruit in any case, so if we have a decade or two then we need to make use of that time. They include:

  + Advancing the science of AI measurement, so that rather than the [current scrappy approach](https://cset.georgetown.edu/article/evaluating-large-language-models/), we have actually-good methods to determine what a given model can and cannot do, how different models compare with each other (and with humans), and how rapidly the frontier is progressing.
...
[1](https://helentoner.substack.com/p/long-timelines-to-advanced-ai-have#footnote-anchor-1-156254921)
...
Personally, my favorite description of AGI is from [Joe Carlsmith](https://arxiv.org/abs/2206.13353): “You know, the big AI thing; *real* AI; the special sauce; the thing everyone else is talking about.”

[2](https://helentoner.substack.com/p/long-timelines-to-advanced-ai-have#footnote-anchor-2-156254921)

See, e.g., this [2016 report](https://obamawhitehouse.archives.gov/sites/default/files/whitehouse_files/microsites/ostp/NSTC/preparing_for_the_future_of_ai.pdf) from the Obama White House: “The current consensus of the private-sector expert community, with which the NSTC Committee on Technology concurs, is that General AI will not be achieved for at least decades.”
